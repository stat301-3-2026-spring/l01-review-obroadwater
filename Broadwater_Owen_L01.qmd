...
- Data cleaning and EDA of the target variable
- Possible transformation of the target variable
- Data splitting to create training and testing set, as well as resampling such as v-fold cross-validation
- Larger EDA of predictors to identify possible feature engineering steps and find ranges for tuning parameters
- Creation of various recipes to prepare for tuning of parameters
- Create workflows for model types, using the previously made recipes
- Tune the model parameters using the resamples
- Evaluate performance of model parameters and model types
- Determine the best model type and parameter set
- Fit the chosen model to the entire training set
- Run the fitted model on the testing set
- Evaluate the predictive performance
- Repeat steps of the process as needed to refine the predictive model
...
Supervised learning uses labeled data and relies on user assumptions such as choosing which predictors to use. Unsupervised learning looks at unlabeled data to create a general idea of the data structures.
...
Describe or emphasize characteristics of a dataset, such as a key trend.
